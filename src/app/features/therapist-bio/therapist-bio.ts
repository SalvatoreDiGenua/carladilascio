...
@Component({
  ...
  template: `
    <main class="bg-cream">
      ...
      <section
        class="border-y border-stone-200/70 bg-white px-4 py-16 sm:px-6 sm:py-20"
        ...
        <div class="mx-auto max-w-6xl">
          ...
          <div class="mt-12 grid gap-6 lg:grid-cols-2">
            @for (method of content.methods; track method.slug) {
              <article
                class="group overflow-hidden rounded-[1.75rem] border border-stone-200 bg-cream-subtle shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
                <div class="grid h-full md:grid-cols-[0.9fr_1.1fr]">
                  <div
                    class="flex min-h-[17rem] items-center justify-center bg-[#edf2f4] p-5 md:min-h-[24rem]"
                  >
                    <img
