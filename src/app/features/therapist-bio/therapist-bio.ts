...
@Component({
  ...
  template: `
    <main class="bg-cream">
      ...
      >
        <div class="mx-auto grid max-w-6xl gap-10 lg:grid-cols-12 lg:items-end">
          <div class="lg:col-span-8">
            ...
            <p
              class="mt-5 max-w-3xl text-xl leading-relaxed text-ink-muted sm:text-2xl"
            >
      ...
      <section class="px-4 py-16 sm:px-6 sm:py-20">
        ...
        >
          <figure class="lg:col-span-5">
            <div
              class="overflow-hidden rounded-[2rem] border border-primary/15 bg-white shadow-lg shadow-ink/5"
            >
              <img
                ngSrc="/carla.jpg"
                width="800"
          ...
          <div class="space-y-10 lg:col-span-7">
            <section aria-labelledby="heading-percorso">
              ...
              <h2
                id="heading-percorso"
                class="mt-3 font-serif text-3xl font-bold text-ink sm:text-4xl"
              >
            ...
            <section
              aria-labelledby="heading-filosofia"
              class="border-t border-stone-200 pt-8"
            >
              <h2
                id="heading-filosofia"
                class="font-serif text-2xl font-bold text-ink"
              >
                {{ 'about.philosophy.title' | transloco }}
              </h2>
              <p class="mt-4 text-base leading-relaxed text-ink-muted">
      ...
      <section
        class="therapist-methods border-y border-stone-200/70 bg-white px-4 py-16 sm:px-6 sm:py-20"
        aria-labelledby="heading-metodologie"
      >
        <div class="mx-auto max-w-6xl">
          <div class="max-w-3xl">
            ...
            <h2
              id="heading-metodologie"
              class="mt-3 font-serif text-3xl font-bold tracking-tight text-ink sm:text-5xl"
            >
          ...
          <div class="therapist-methods__grid mt-12 grid gap-6 lg:grid-cols-2">
            @for (method of content.methods; track method.slug) {
              ...
              >
                ...
                >
                  <div
                    class="therapist-method-card__media flex min-h-[17rem] items-center justify-center bg-[#edf2f4] p-5 md:min-h-[24rem]"
                  >
                    <img
                      ...
                      height="760"
                      loading="lazy"
                      class="therapist-method-card__image block h-auto max-h-[23rem] w-full object-contain transition duration-500 group-hover:scale-[1.015]"
      ...
      <section
        ...
        aria-labelledby="heading-approccio"
      >
        <div class="mx-auto max-w-6xl">
          <div class="max-w-3xl">
            <p
      ...
      <section
        class="border-y border-stone-200/70 bg-cream-subtle px-4 py-16 sm:px-6 sm:py-20"
      ...
      <section
        class="px-4 py-16 sm:px-6 sm:py-20"
        aria-labelledby="heading-percorsi"
      >
        <div class="mx-auto grid max-w-6xl gap-10 lg:grid-cols-12 lg:items-end">
          <div class="lg:col-span-8">
            <p
      ...
      <section
        ...
        aria-labelledby="heading-arte-terapia"
      >
        <div class="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-12">
          <div class="lg:col-span-7">
            ...
            <p
              class="mt-5 max-w-2xl text-base leading-relaxed text-cream/75 sm:text-lg"
            >
              {{ 'about.journey.paragraph1' | transloco }}
            </p>
            <p
              class="mt-4 max-w-2xl text-base leading-relaxed text-cream/75 sm:text-lg"
            >
          ...
          <figure class="lg:col-span-5">
            <div
              class="overflow-hidden rounded-[2rem] border border-cream/10 bg-white/5"
            >
              <img
            ...
            <figcaption class="mt-3 text-xs text-cream/55">
              {{ 'home.hero.artworkTitle' | transloco }} ·
              {{
                'home.hero.artworkCredit'
