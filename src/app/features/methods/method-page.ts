...
@Component({
  ...
  template: `
    @if (method(); as m) {
      <article class="method-page mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-16">
        ...
        <div class="method-page__content">
          ...
          <header class="mb-12 max-w-3xl">
            <p class="mb-3 text-xs font-semibold tracking-[0.18em] text-aqua uppercase">
              {{ 'header.nav.methods' | transloco }}
            </p>
            <h1
            ...
            <div class="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              >
                <div hlmCardHeader class="p-6">
                  <h3 hlmCardTitle id="heading-svolgimento" class="text-lg font-bold text-ink">
              ...
              >
                <div hlmCardHeader class="p-6">
                  <h3 hlmCardTitle id="heading-destinatari" class="text-lg font-bold text-ink">
                  ...
                  <ul class="space-y-2 text-sm text-ink-muted">
                    @for (item of m.audience; track item) {
                      <li class="flex items-center gap-2">
                        <span class="h-1.5 w-1.5 shrink-0 rounded-full bg-aqua"></span>
