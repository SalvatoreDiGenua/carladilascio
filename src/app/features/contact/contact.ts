          ...
          <div hlmCard class="border-stone-200/90 bg-white/80 shadow-xs">
            ...
            <div hlmCardContent class="px-6 pb-6 sm:px-8 sm:pb-8">
              ...
              <li class="flex items-start gap-3">
                ...
                >
                  <ng-icon name="lucidePhone" class="size-5" aria-hidden="true" />
                </div>
                <div>
              ...
              <li class="flex items-start gap-3">
                ...
                >
                  <ng-icon name="lucideMail" class="size-5" aria-hidden="true" />
                </div>
                <div>
                  <span class="block font-semibold text-ink">{{
              ...
              <li class="flex items-start gap-3">
                ...
                >
                  <ng-icon name="lucideMapPin" class="size-5" aria-hidden="true" />
                </div>
                <div>
                  <span class="block font-semibold text-ink">{{
